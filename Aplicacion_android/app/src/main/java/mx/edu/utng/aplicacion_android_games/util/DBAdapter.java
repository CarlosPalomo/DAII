package mx.edu.utng.aplicacion_android_games.util;
...
import mx.edu.utng.aplicacion_android_games.LogeoActividad;
import mx.edu.utng.aplicacion_android_games.dao.DBHelper;
import mx.edu.utng.aplicacion_android_games.model.Modulo;
import mx.edu.utng.aplicacion_android_games.model.Question;
import mx.edu.utng.aplicacion_android_games.model.Tema;
...
//64  164
    ...
    public List<mx.edu.utng.aplicacion_android_games.Question> getAllQuestions( int dd) {

        List<mx.edu.utng.aplicacion_android_games.Question> quesList = new ArrayList<mx.edu.utng.aplicacion_android_games.Question>();
        String selectQuery="";
        Cursor cursor;
        switch (dd){
            case 0:
                ...
                if (cursor.moveToFirst()) {
                    do {
                        mx.edu.utng.aplicacion_android_games.Question quest = new mx.edu.utng.aplicacion_android_games.Question();
