...
public class QuizActivityCinco extends AppCompatActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		//asignar lo de la base de datos
		...
		setQuestionView();
		//se llava el control de las preguntas
...
//finalizar el tiempo
		...
		public void onFinish() {
			...
			Intent a = new Intent(getApplicationContext(), ResultActivityCinco.class);
			startActivity(a);
		}
	}
	@Override
	...
	{//enviar lapregunta con respuesta
